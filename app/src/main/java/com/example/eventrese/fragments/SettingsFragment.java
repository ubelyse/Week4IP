...
import com.example.eventrese.activities.ChangePassWordActivity;
import com.example.eventrese.activities.LoginActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnAboutApp:
                Toast.makeText(getActivity(),"TEEN'S HEALTH ADVISORY\nPERIOD TRACKING CALENDAR",
