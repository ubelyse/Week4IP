...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button mlogin;
    @BindView(R.id.buttonSwitchRegister)
    Button mswitchregister;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mswitchregister.setOnClickListener(this);
    ...
    private void loginWithPassword() {
        String email = mun.getText().toString().trim();
        String password = mpsd.getText().toString().trim();
        if (email.equals("")) {
            mun.setError("Please enter your email");
            return;
        }
        if (password.equals("")) {
            mpsd.setError("Password cannot be blank");
            return;
        }
